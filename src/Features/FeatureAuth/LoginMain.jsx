  ...
  return (
    <>
      <div className={`w-full object-cover relative`}>
        <div className={`grid grid-cols-2 w-full justify-center max-lg:grid-cols-1`}>
          <div className={`flex justify-center items-center w-auto h-screen max-lg:h-[600px]`}>
            <img
              src={`/Media/login.png`}
              alt="login"
          ...
          >
            ...
            <div
              className={`flex justify-center items-center w-full mt-[2rem]`}
            >
              <AuthBtn
