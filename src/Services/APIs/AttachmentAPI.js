...
export const AttachmentTableData = async (file, currentPage, itemsPerPage) => {
  try {
    const response = await axios.get(
      `${
        import.meta.env.VITE_REACT_APP_BASE_URL
      }/attachment/table-data?target_file=${file}&current_page=${currentPage}&item_per_page=${itemsPerPage}`,
      {
        headers: {
