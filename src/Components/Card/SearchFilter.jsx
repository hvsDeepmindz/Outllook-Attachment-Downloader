...
const SearchFilter = ({ pageTitle }) => {
  return (
    <>
      <div
        className={`py-[6rem] px-[10rem] relative object-cover w-auto flex flex-col`}
      >
        ...
        {/* Search Bar */}
        <div
          className={`flex justify-end w-auto mt-[2rem] items-center gap-[2rem]`}
        >
          <div
