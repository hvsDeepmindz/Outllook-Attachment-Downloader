      ...
      >
        ...
        <div className={`flex justify-between w-full items-start px-[2rem]`}>
          <ProgressDesign
            ...
            progressPercentDone={600}
            progressColor={"#FAAD14"}
            progressDoneColor={"#52C41A"}
            progressSize={200}
            progressWidth={"15"}
            progressPercentFailed={627}
            progressFailedColor={"#F5222D"}
          />
          <div className={`flex flex-col gap-[3rem] mr-[10rem]`}>
            <div className={`flex items-start gap-[1rem]`}>
              <div
                className={`rounded-full px-[0.8rem] py-[0.8rem] bg-[#52C41A] mt-[0.5rem]`}
              ></div>
            ...
            <div className={`flex items-start gap-[1rem]`}>
              <div
                className={`rounded-full px-[0.8rem] py-[0.8rem] bg-[#FAAD14] mt-[0.5rem]`}
              ></div>
              <div className={`flex flex-col gap-[0.5rem]`}>
                <p className={`text-[1.6rem] font-normal text-[#999999]`}>
                  Pending
            ...
            <div className={`flex items-start gap-[1rem]`}>
              <div
                className={`rounded-full px-[0.8rem] py-[0.8rem] bg-[#F5222D] mt-[0.5rem]`}
              ></div>
              <div className={`flex flex-col gap-[0.5rem]`}>
                <p className={`text-[1.6rem] font-normal text-[#999999]`}>
                  Failed
